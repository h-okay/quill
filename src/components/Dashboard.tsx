...
export default function Dashboard({ subscriptionPlan }: DashboardProps) {
  ...
  return (
    <main className="mx-auto max-w-7xl md:p-10 ">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 dark:border-[#2d2d2d] pb-5 sm:flex-row sm:items-center sm:gap-0">
      ...
      {files && files.length !== 0 ? (
        ...
        <Skeleton height={100} className="my-2 dark:bg-[#0a0a0a]" count={3} />
      ) : (
